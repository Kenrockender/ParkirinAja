...
const dict = {
  id: {
    ...
    heroSub: "Reservasi slot favoritmu di Gedung Parkir Anggrek, check-in & keluar langsung dari aplikasi. Selesai.",
    ...
    wcLabel: "WC",
    legend: "Legenda",
    mapNote: "Mobil masuk lewat kanan-atas → ketuk slot hijau untuk booking",
  ...
  en: {
    ...
    heroSub: "Reserve your favorite slot at Anggrek Parking Building, check in & out right from the app. Done.",
    ...
    wcLabel: "WC",
    legend: "Legend",
    mapNote: "Cars enter top-right → tap a green slot to book",
