...
const dict = {
  id: {
    ...
    anaForecastSub: "Holt-Winters aditif · musiman mingguan (168 jam)",
    anaModelCard: "Model Card",
    anaMcMethod: "Metode",
    anaMcMethodVal: "Holt-Winters aditif (level + tren + musiman mingguan 168 jam)",
    anaMcFeatures: "Fitur",
  ...
  en: {
    ...
    anaForecastSub: "Holt-Winters additive · weekly seasonality (168h)",
    anaModelCard: "Model Card",
    anaMcMethod: "Method",
    anaMcMethodVal: "Holt-Winters additive (level + trend + 168h weekly seasonality)",
